...
| H-002 | 1회 플레이 시간 | 30~40분 | 동의 | **재검토 필요** | 30~40분 승인 → 멀티 전환 논의 중 폐기 → 멀티 철회로 **다시 미정**. 경위는 `product-direction-v0.6.md` §5 |
...
| H-007 | 제품 명칭 범위 | (미제안) | 명칭 일반화 지지 | 승인 | **"메모리"로 일반화 — 명칭·프레이밍만.** NAND 등 제품군 실제 확장은 보류. 코드 표기 교체는 H-002 확정 후 |
...
| BM-002 | 첫 BM 수직 슬라이스 | 5개 부서 Fab Operations Board + 프로젝트 타일 뒤집기 + 기존 인과 카드 연결 | 동의 | **승인(착수 보류)** | 방향 승인. 착수는 H-002 세션 길이 확정 후 — 정보 밀도·연출 길이가 거기 종속 |
